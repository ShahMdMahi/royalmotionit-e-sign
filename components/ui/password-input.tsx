...
export function PasswordInput({ className, ...props }: PasswordInputProps) {
  ...
  return (
    <div className="relative">
      ...
      <Button type="button" variant="ghost" size="sm" className="absolute right-0 top-0 h-full px-3 py-1 hover:bg-transparent" onClick={() => setShowPassword(!showPassword)} tabIndex={-1}>
