...
import { registerUser, googleAuth } from "@/actions/auth";
    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="space-y-3">
        ...
        <form action={googleAuth}>
          <Button variant="outline" className="w-full h-8 text-sm" type="submit" onClick={() => toast.info("Redirecting to Google authentication...")}>
