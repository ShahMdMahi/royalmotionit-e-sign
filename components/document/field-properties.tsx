      ...
      <div className="py-4">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full grid grid-cols-3 mb-4">
            <TabsTrigger value="general" className="transition-all">
              General
            </TabsTrigger>
            <TabsTrigger value="appearance" className="transition-all">
              Appearance
            </TabsTrigger>
            <TabsTrigger value="conditional" className="transition-all">
              Conditional Logic
            </TabsTrigger>
          </TabsList>
                  ...
                  <PopoverTrigger asChild>
                    <Button variant="outline" className="w-full justify-start">
                      <div
                        className="h-4 w-4 rounded border mr-2"
                        style={{
                          backgroundColor: localField.textColor || "#000000",
                        }}
                      />
                  ...
                  <PopoverTrigger asChild>
                    <Button variant="outline" className="w-full justify-start">
                      <div
                        className="h-4 w-4 rounded border mr-2"
                        style={{
                          backgroundColor: localField.borderColor || "#cccccc",
                        }}
                      />
