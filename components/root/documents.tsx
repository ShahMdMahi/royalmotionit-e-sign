    ...
    <div className="container mx-auto py-4 sm:py-6 md:py-8 lg:py-10 max-w-7xl px-3 sm:px-4 md:px-6">
      ...
      <Tabs defaultValue={defaultTab} className="w-full">
        <div className="mb-4 sm:mb-6 md:mb-8 border-b border-border/80 overflow-x-auto">
          <TabsList
            className={`grid w-full ${isAdmin ? "grid-cols-2" : "grid-cols-1"} md:w-auto justify-start bg-transparent h-10 sm:h-12`}
          >
            {isAdmin && (
              <TabsTrigger
                value="authored"
              ...
              <CardContent className="p-6 space-y-6 sm:space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {authorDocuments.map((doc) => (
                    <Card
                      key={doc.id}
                      className="group border-border shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary/50 hover:-translate-y-1 flex flex-col h-full"
                    >
                      <CardHeader className="pb-3 space-y-3">
                        <div className="flex flex-col xs:flex-row xs:justify-between xs:items-start gap-2 xs:gap-3">
                          <CardTitle className="truncate-2 text-base xs:text-lg font-semibold group-hover:text-primary transition-colors">
                            {doc.title}
                          </CardTitle>
                          <Badge
                            variant={
                        ...
                        <CardDescription className="line-clamp-2 text-xs xs:text-sm">
                          {doc.description
                            ? doc.description
                      ...
                      <CardContent className="pb-3 space-y-4">
                        ...
                        <div className="bg-muted/5 rounded-lg p-2 xs:p-3 space-y-2.5">
                          ...
                          <div className="flex items-center justify-between text-[11px] xs:text-xs">
                            <span className="text-muted-foreground flex items-center gap-1.5">
                              <Clock className="h-3 w-3 xs:h-3.5 xs:w-3.5" />{" "}
                              Updated:
                            </span>
                            <span className="font-medium">
                          ...
                          {doc.expiresAt && (
                            <div className="flex items-center justify-between text-[11px] xs:text-xs">
                              <span className="text-muted-foreground flex items-center gap-1.5">
                                <TimerOff className="h-3 w-3 xs:h-3.5 xs:w-3.5" />{" "}
                                Expires:
                              </span>
                              <span
                          ...
                          {doc.dueDate && (
                            <div className="flex items-center justify-between text-[11px] xs:text-xs">
                              <span className="text-muted-foreground flex items-center gap-1.5">
                                <AlertCircle className="h-3 w-3 xs:h-3.5 xs:w-3.5" />{" "}
                                Due:
                              </span>
                              <span
