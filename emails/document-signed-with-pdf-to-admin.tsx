...
interface DocumentSignedWithPdfToAdminProps {
  adminName: string;
...
export const DocumentSignedWithPdfToAdmin = ({
  adminName,
  documentTitle,
  documentId,
  signerName,
  signerEmail,
  message,
}: DocumentSignedWithPdfToAdminProps) => {
  const baseUrl =
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          >
            ...
            >
              Document Signed with PDF Attached
            </Heading>
          </Section>
          ...
          <Section style={contentSection}>
            ...
            >
              ...
              <Text style={documentMessage as any}>
                <strong>Signed by:</strong> {signerName} ({signerEmail})
              </Text>
              <Text style={documentMessage as any}>
                <strong>Status:</strong> Signed and Complete
              </Text>
              {message && (
                <Text style={documentMessage as any}>
            ...
            >
              ...
              <Text style={securityText as any}>
                • Share the document with additional stakeholders as needed
              </Text>
            </Section>
...
export default DocumentSignedWithPdfToAdmin;
