...
export const metadata: Metadata = {
  ...
  description:
    "Learn about how Royal Sign uses cookies to provide and improve our e-signature service.",
};
    ...
    <div className="container mx-auto px-4 py-12 space-y-16">
      ...
      <section className="max-w-4xl mx-auto">
        <Card className="bg-secondary/30 border">
          <CardContent className="p-6 md:p-8">
            <p className="mb-4">
              This Cookie Policy explains how RoyalMotionIT (&quot;we&quot;,
              &quot;us&quot;, or &quot;our&quot;) uses cookies and similar
              technologies when you visit our Royal Sign e-signature platform
              and associated websites. It explains what these technologies are
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <p>
          ...
          owners. Cookies enhance your browsing experience by:
        </p>
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-muted p-4 rounded-md">
                ...
                <ul className="text-sm text-muted-foreground list-disc pl-5 mt-2">
                  <li>
                    Authentication cookies that identify you when you log into
                    our platform
                  </li>
                  <li>Security cookies that help prevent fraudulent use</li>
                  <li>
                    Session cookies that remember actions during a browser
                    session
                  </li>
                </ul>
              </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-muted p-4 rounded-md">
                ...
                <ul className="text-sm text-muted-foreground list-disc pl-5 mt-2">
                  ...
                  <li>
                    Cookies that customize the site based on your previous
                    actions
                  </li>
                  <li>
          ...
          <Card className="border-l-4 border-l-primary/50 card-hover border">
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                ...
                This helps us improve our platform.
              </p>
              <div className="bg-muted p-4 rounded-md">
                <p className="text-sm font-medium">Examples:</p>
                <ul className="text-sm text-muted-foreground list-disc pl-5 mt-2">
                  <li>
                    Google Analytics cookies that track page visits and user
                    behavior
                  </li>
                  <li>
                    Cookies that measure which features users engage with most
                  </li>
          ...
          <Card className="border-l-4 border-l-primary/30 card-hover border">
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                ...
                see an ad. They can share information with other organizations
                or advertisers.
              </p>
              <div className="bg-muted p-4 rounded-md">
                <p className="text-sm font-medium">Examples:</p>
                <ul className="text-sm text-muted-foreground list-disc pl-5 mt-2">
                  <li>
                    Cookies that track which pages you visit across websites
                  </li>
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <p>
          Some cookies are placed by third parties on our behalf. Third parties
          include search engines, providers of measurement and analytics
        ...
        <p className="text-muted-foreground">
          ...
          other websites. This information may be used to provide analytics,
          content personalization, or advertising that is more relevant to your
          interests.
        </p>
        ...
        <div className="mt-4 bg-secondary/30 rounded-md p-4">
          ...
          <p className="text-sm mt-4 text-muted-foreground">
            Each third party has its own privacy and cookie policies. We
            encourage you to read these providers&apos; privacy policies to
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <p>
          ...
          preferences. Here&apos;s how you can manage cookies in popular
          browsers:
        </p>
        ...
        <p className="text-muted-foreground mt-4">
          ...
          our website. If you block cookies, you may not be able to use all
          features of Royal Sign.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <p>
          ...
          cookies through a cookie banner. You can change your preferences at
          any time through our cookie settings accessible via the footer of our
          website.
        </p>

        <p className="text-muted-foreground">
          By continuing to use our site after setting your cookie preferences,
          you agree to our use of cookies in accordance with your settings and
          this Cookie Policy.
        </p>
      </section>
      ...
      <section className="gradient-bg rounded-xl p-8 md:p-12 max-w-4xl mx-auto text-primary-foreground">
        <div className="space-y-6">
          ...
          <p>
            ...
            this Cookie Policy, please contact our privacy team.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              ...
              asChild
            >
              <Link href="mailto:privacy@royalmotionit.com">
                Email Privacy Team
              </Link>
            </Button>
          </div>
