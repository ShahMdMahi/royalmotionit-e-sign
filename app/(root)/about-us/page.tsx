...
export const metadata: Metadata = {
  ...
  description:
    "Learn about RoyalMotionIT and our mission to revolutionize electronic signatures with our Royal Sign platform.",
};
    ...
    <div className="container mx-auto px-4 py-12 space-y-16">
      ...
      <section className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground">
          Transforming document workflows with secure, efficient e-signatures
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p>
            Royal Sign was founded in 2020 by a team of tech entrepreneurs who
            recognized the need for a more secure, user-friendly, and legally
            compliant e-signature solution in an increasingly digital world.
          </p>

          <p className="text-muted-foreground">
            As businesses shifted toward remote work and digital transformation,
            we saw an opportunity to create a platform that would simplify the
            document signing process while maintaining the highest standards of
            security and compliance.
          </p>

          <p>
            Today, Royal Sign serves thousands of businesses and individuals
            across the globe, providing a seamless e-signature experience that
            saves time, reduces costs, and improves efficiency.
          </p>
        </div>
        ...
        <Card className="bg-secondary/30 border overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <CardContent className="p-8 border-b md:border-b-0 md:border-r border-border">
              ...
              <p className="text-muted-foreground">
                To empower businesses and individuals with a secure, legally
                binding, and intuitive electronic signature solution that
                accelerates document workflows and facilitates seamless
            ...
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                To be the global standard for electronic signatures, known for
                exceptional security, ease of use, and innovation. We aim to
                eliminate paper from business processes worldwide, contributing
                to both operational efficiency and environmental sustainability.
              </p>
            </CardContent>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <Card className="card-hover border h-full">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                else, implementing industry-leading encryption and protection
                measures.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover border h-full">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                software development to customer support, ensuring a premium
          ...
          <Card className="card-hover border h-full">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground">
                We continuously innovate and improve our platform, embracing new
                technologies to solve complex problems and enhance user
                experience.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover border h-full">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                to feedback, anticipate needs, and build solutions that truly
                serve our users.
              </p>
            </CardContent>
          </Card>
      ...
      <section className="max-w-5xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl">
            Meet the experienced professionals guiding Royal Sign&apos;s vision
            and growth
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Cybersecurity expert with background in cryptographic systems and
              digital identity
            </p>
          </div>
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Operations strategist with expertise scaling SaaS businesses
              internationally
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-0 overflow-hidden">
            <div className="p-6">
              <p className="text-center mb-6">
                Royal Sign serves customers in over 150 countries, with offices
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="card-hover border">
            <CardContent className="p-6 space-y-4">
              ...
              <blockquote className="italic text-muted-foreground">
                &quot;Royal Sign has transformed how our legal team handles
                contracts. The platform is intuitive, secure, and has cut our
                document processing time by 75%. The audit trail feature gives
                us peace of mind for compliance.&quot;
              </blockquote>
          ...
          <Card className="card-hover border">
            <CardContent className="p-6 space-y-4">
              ...
              <blockquote className="italic text-muted-foreground">
                &quot;As a small business owner, I needed an e-signature
                solution that was affordable yet professional. Royal Sign
                delivers on both fronts, plus their customer service is
                exceptional. I can&apos;t imagine running my business without it
                now.&quot;
              </blockquote>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Founder, Bright Ideas Consulting
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p>
            ...
            mission. At Royal Sign, you&apos;ll work on challenging projects
            that make a real impact in the digital transformation space.
          </p>
        </div>
      ...
      <section className="gradient-bg rounded-xl p-8 md:p-12 max-w-4xl mx-auto text-primary-foreground">
        <div className="space-y-6">
          ...
          <p>
            Have questions about Royal Sign? We&apos;d love to hear from you and
            discuss how we can help transform your document workflows.
          </p>
